...
A deep dive into image capture options: formats, viewport, zoom, delay, and more.
...
A `zoom=2` produces an image that is 2× the viewport dimensions in pixels — ideal for HiDPI displays.
